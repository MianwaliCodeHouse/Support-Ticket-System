    ...
    <div id="createTicketModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-10 hidden">
        <div class="bg-white rounded-lg shadow-lg w-96">
            ...
            <form id="createTicketForm" class="p-4">
                ...
                <button type="button" class="mt-4 w-full px-4 py-2 text-white bg-blue-500 rounded hover:bg-blue-700"
    ...
    <div id="editTicketModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-10 hidden">
        <div class="bg-white rounded-lg shadow-lg w-96">
            ...
            <form id="editTicketForm" class="p-4">
                ...
                <button type="button" class="mt-4 w-full px-4 py-2 text-white bg-green-500 rounded hover:bg-green-700"
                    onclick="updateTicket(editId.value)">Update</button>
            </form>
        </div>
    </div>
        ...
        var table = $('#ticketsDataTable').DataTable({
            ...
            columns: [{
                    ...
                    render: function(data, type, row, meta) {
                        return meta.row + meta.settings._iDisplayStart + 1; // Generate the correct index
                    }
                },
                @if (auth()->user()->hasRole('admin'))
                    {
